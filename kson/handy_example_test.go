...
func ExampleGetString() {
	...
	s := kson.GetString(data, "foo", "bar", "1")
...
func ExampleGetInt() {
	...
	n1 := kson.GetInt(data, "foo", "0")
	fmt.Printf("data.foo[0] = %d\n", n1)

	n2 := kson.GetInt(data, "foo", "2", "bar", "0")
